...
'<div class="field-group">' +
    '<label for="'+name+'">'+escapedLabel+(!item.required?'':'<span class="aui-icon icon-required">(required)</span>')+'</label>'+
    '<input class="text medium-field" type="text" id="prnfb-form-'+name+'" name="'+name+'" placeholder="'+escapedValue+'" value="'+escapedValue+'">'+
...
'</div>')
 ...
 var textareaTemplate = function(name, item) {
  ...
  var escapedDescription = _.escape(item.defaultDescription);
   return $(''+
'<div class="field-group">' +
    '<label for="'+escapedName+'">'+escapedLabel+(!item.required?'':'<span class="aui-icon icon-required">(required)</span>')+'</label>'+
    '<textarea class="textarea" id="prnfb-form-'+name+'" name="'+name+'" placeholder="'+escapedValue+'">'+escapedValue+'</textarea>'+
    '<div class="description">'+escapedDescription+'</div>'+
'</div>')
 };
 ...
 var checkboxTemplate = function(name, item) {
   var checkboxItemTemplate = function(nestedItem, num) {
    ...
    return $('<div class="checkbox">\
      ...
      name="'+outerName+'[]" id="prnfb-form-'+outerName+'-'+num+'"><label for="prnfb-form-'+outerName+'-'+num+'"\
      >'+itemLabel+'</label></div>');
   }
